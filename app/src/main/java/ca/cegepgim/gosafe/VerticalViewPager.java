...
public class VerticalViewPager extends ViewPager {
    ...
    private class VerticalPageTransformer implements ViewPager.PageTransformer {
        ...
        public void transformPage(@NonNull View page, float position) {
            if (position < -1) {
                ...
                //set Y position to swipe it from top.
    ...
    private MotionEvent swapXYCordinate(MotionEvent event) {
        //now we will swap x and y cordinate using this
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        swapXYCordinate(ev); //return touch coordinates to original reference from for any child value...
        return intercepted;
    }
